...
async def test_follow_users(async_spotify_user_auth, john_smith_user_id, spotify_test_user_id):
    assert await async_spotify_user_auth.follow_users([john_smith_user_id, spotify_test_user_id]) is not None
...
async def test_follows_users(async_spotify_user_auth, john_smith_user_id, spotify_test_user_id):
    assert await async_spotify_user_auth.follows_users([john_smith_user_id, spotify_test_user_id]) is not None
